...
To enable use antinuke enable ** `)
            ...
            const wl = client.util.embed()
                ...
                .addFields([
                    {
                        name: `__**Usage**__`,
                        value: `<:dot:1436754655697699019> \`${message.guild.prefix}whitelist @user/id\`\n<:dot:1436754655697699019> \`${message.guild.prefix}wl @user\``
                    }
                ])
                ...
                msg = await message.channel.send({
                    embeds: [
                        client.util.embed()
                            ...
                            .setColor(client.color)
                            .setDescription(
                                `<:cross:1436754701369737237><:tick:1436755134561521766> : **Ban**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Kick**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Prune**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Bot Add**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Server Update\n<:cross:1436754701369737237><:tick:1436755134561521766> : Member Role Update**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Channel Create**\n<:cross:1436754701369737237><:tick:1436755134561521766> :** Channel Delete**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Channel Update**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Role Create**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Role Delete**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Role Update**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Mention** @everyone\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Webhook Management**\n<:cross:1436754701369737237><:tick:1436755134561521766> : **Emojis & Stickers Management**`
                            )
                            .addFields(
                                {
                                    name: `**Executor**`,
                ...
                msg = await message.channel.send({
                    embeds: [
                        client.util.embed()
                            ...
                            .setColor(client.color)
                            .setDescription(
                                `${data.ban ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Ban**\n${data.kick ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Kick**\n${data.prune ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Prune**\n${data.botadd ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Bot Add**\n${data.serverup ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Server Update\n${data.memup ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: Member Role Update**\n${data.chcr ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Channel Create**\n${data.chdl ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: ** Channel Delete**\n${data.chup ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Channel Update**\n${data.rlcr ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Role Create**\n${data.rldl ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Role Delete**\n${data.rlup ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Role Update**\n${data.meneve ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Mention** @everyone\n${data.mngweb ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Webhook Management**\n${data.mngstemo ? '<:cross:1436754701369737237><:tick:1436755134561521766> ' : '<:cross:1436754701369737237><:tick:1436755134561521766> '}: **Emojis & Stickers Management**`
                            )
                            .addFields(
                                {
                                    name: `**Executor**`,
